...
!function (l) {
  ...
  !function (t) {
    ...
    } else document.attachEvent && (i = t, o = l.document, n = !1, c = function c() {
      n || (n = !0, i());
    }, (_a = function a() {
      try {
    ...
    var t, e;
    (t = document.createElement("div")).innerHTML = i, i = null, (e = t.getElementsByTagName("svg")[0]) && (e.setAttribute("aria-hidden", "true"), e.style.position = "absolute", e.style.width = 0, e.style.height = 0, e.style.overflow = "hidden", function (t, e) {
...
}
{
  ...
  _vm3.$on('click', spy); // 希望函数被调用


  var button = _vm3.$el;
  button.click(); // 期望间谍被调用
